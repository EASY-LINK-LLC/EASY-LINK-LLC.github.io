// Setup
$("#selectCPU option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectRAM option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectHDD0 option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectHDD1 option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectHDD2 option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectHDD3 option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectRaid option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectBW option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectIP option:first").prop('selected', 'selected').prop('disabled', 'disabled');
$("#selectDDoS option:first").prop('selected', 'selected').prop('disabled', 'disabled');
...
function updateServerOption() {
    ...
    selectedRAM.selectedIndex == 0 ? selectedRAMPrice = 0 : selectedRAMPrice = selectedRAM.value;
    ...
    // e3 series
    if (selectedCPU.selectedIndex === 2 || selectedCPU.selectedIndex === 3 || selectedCPU.selectedIndex === 4) {
    ...
    var price = '<label>CPU:</label>' +
        ...
        '<br>' + '<label>RAID:</label>' +
        selectedRaidDesc +
        '<br>' + '<label>Bandwidth:</label>' +
        selectedBWDesc +
        '<br>' + '<label>IPv4:</label>' +
        selectedIPDesc +
        '<br>' + '<label>OS:</label>' +
        selectedOSDesc +
        '<br>' + '<label>Firewall:</label>' +
        selectedDDoSDesc +
        '<br><h4>Total:</h4> ' + 
        '<a href="#" onclick="sendMail();">$' + recurringPrice + '/Month <i class="fa fa-shopping-cart fa-lg"></i></a>';
